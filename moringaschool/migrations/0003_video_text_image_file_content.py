...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('moringaschool', '0002_rename_module_course_cohort'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contents', to='moringaschool.module')),
            ],
        ),
    ]
